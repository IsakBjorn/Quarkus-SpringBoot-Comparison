...
public class ReactiveFruitResource {
  private static final Logger LOGGER = Logger.getLogger(ReactiveFruitResource.class.getName());

  private final FruitService fruitService;

  public ReactiveFruitResource(FruitService fruitService) {
  ...
  public Uni<Fruit> getSingle(@RestPath Long id) {
    ...
    Uni<Fruit> fruit = Fruit.findById(id);
    return fruit;
  }

  @GET
  @Path("{id}")
  public Uni<Fruit> getSingleBlocking(@RestPath Long id) {
